...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-[1200px] mx-auto flex gap-4 justfy-between">
            <div class="w-2/5">
                ...
                <div class="border border-gray-300 rounded-lg">
                    <div class="my-2 mx-3 mb-2">
                        <div class="flex items-center justify-center border-b border-gray-300 pb-1">
                            ...
                            <MapMarkerOutline :size="17" /> Delivery to {{$page.props.auth.user.first_name}} -
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <buttom :disabled="isAlreadyInCart" @click="addToCart(product)"
