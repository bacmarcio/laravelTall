    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <TextInput id="name" type="text" class="mt-1 block w-full" v-model="form.last_name" required
            ...
            <div class="text-xs pt-4">
                By signing-in you agree to Grupo AVS Conditions of Use & Sale.
                Please see our Privacy Notice, our Cookies Notice and our Interst-Based Ads Notice.
            </div>
