    ...
    <div class="min-w-[1150px] bg-gray-100 h-full">
        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed z-50 min-w-[1150px] w-full">
            ...
            <div class="flex grow items-center h-[45px] px-1">
                <div
                    class="flex items-center justify-center bg-gray-100 border-r border-r-gray-300 font-extrabold text-[11px] text-gray-600 w-[60px] h-[40px] rounded-1-md cursor-pointer">
                    <div class="pt-[3px]">
                        All
                    </div>
                                ...
                                <div class="w-1/2 ml-5">
                                    <div class="pb-3">
                                        ...
                                        <Link :href="route('logout')" method="post" as="button"
                                            class="text-sm block hover:text-red-600 hover:underline pt-3">Sign Out
                                        </Link>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="flex items-center justify-between bg-[#232f3e] h-[38px] fixed z-40 min-w-[1150px] w-full mt-[60px]">
            <div class="flex">
                ...
                <div
                    class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">Costume Services</div>
                    </div>
                </div>
                <div
                    class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">Márcio Grupoavs.com</div>
                    </div>
                </div>
            </div>
            <div class="flex">
        ...
        <footer class="bg-[#232f3e]">
            ...
            <div class="flex items-stretch justify-between max-w-[1000px] mx-auto p-10 text-white">
                <ul>
                    ...
                    <li class="hover:underline cursor-pointer">About AVS</li>
                    <li class="hover:underline cursor-pointer">Investidor Relations</li>
                    <li class="hover:underline cursor-pointer">AVS Devices</li>
                    <li class="hover:underline cursor-pointer">AVS Science</li>
                </ul>
                <ul>
                    <li class="font-extrabold text-lg">Make Money with Us</li>
                    <li class="hover:underline cursor-pointer">Sell products on AVS</li>
                    <li class="hover:underline cursor-pointer">Sell on AVS Business</li>
                    <li class="hover:underline cursor-pointer">Sell aps on AVS</li>
                    ...
                    <li class="hover:underline cursor-pointer">Host an AVS Hub</li>
                </ul>
                <ul>
                    <li class="font-extrabold text-lg">Get to Know Us</li>
                    <li class="hover:underline cursor-pointer">Careers</li>
